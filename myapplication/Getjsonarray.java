...
public class Getjsonarray extends AsyncTask<String,String,String> {
    ...
    protected void onPreExecute() {
        progress = new sql(context).loading("Loading","show");
    }
    ...
    protected String doInBackground(String... strings) {
        ...
        try{
            switch (u){
                case "http://192.168.1.12/Display.php":{
                    urls = u;
                    sdate = strings[2];
                    edate = strings[3];
                    keyword = strings[4];
                ...
                case "http://192.168.1.12/User_details.php":{
                    urls = u;
                    sdate = "Nothing";
                    edate = "Nothing";
                    keyword="Nothing";
                ...
                case "http://192.168.1.12/Total_exp_inc.php":{
                    urls = u;
                    sdate = "Nothing";
                    edate = "Nothing";
                    keyword="Nothing";
                ...
                case "http://192.168.1.12/Total_Data.php":{
                    urls = u;
                    sdate = strings[2];
                    edate = strings[3];
                    keyword="Nothing";
